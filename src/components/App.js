...
function App() {
  ...
  const LOCAL_STORAGE_KEYs="contacts"
  ...
  useEffect(() => {
     const retriveContacts = JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEYs));
  ...
  // FOR STORING THE DATA
   useEffect(() => {
       localStorage.setItem(LOCAL_STORAGE_KEYs, JSON.stringify(contacts))
   }, [contacts])
